-- SSA Admin Database Schema
-- Fiddletown Data Management System
-- 
-- This file contains the complete database schema for the SSA Admin application.
-- Use this to recreate the database from scratch in Supabase.
--
-- Instructions:
-- 1. Go to your Supabase project dashboard
-- 2. Navigate to SQL Editor
-- 3. Run this script to create all tables, policies, and functions
...
/*
-- Sample locations
INSERT INTO locations (name, slug, region, short_description, website_url, status) VALUES
    ('Fiddletown Winery', 'fiddletown-winery', 'Fiddletown', 'Family-owned winery with award-winning wines', 'https://fiddletownwinery.com', 'published'),
    ('Shenandoah Valley Vineyards', 'shenandoah-valley-vineyards', 'Shenandoah Valley', 'Historic vineyard with tasting room', 'https://shenandoahvalleyvineyards.com', 'published');

-- Sample events
INSERT INTO events (name, slug, host_org, start_date, end_date, location, status) VALUES
    ('Wine Tasting Festival', 'wine-tasting-festival', 'Fiddletown Chamber of Commerce', '2024-06-15', '2024-06-15', 'Fiddletown Community Center', 'published'),
    ('Harvest Celebration', 'harvest-celebration', 'Local Wineries', '2024-09-20', '2024-09-22', 'Various Locations', 'published');

-- Sample routes
INSERT INTO routes (name, slug, duration_minutes, start_point, end_point, difficulty, status) VALUES
    ('Fiddletown Loop Trail', 'fiddletown-loop-trail', 120, 'Fiddletown Park', 'Fiddletown Park', 'easy', 'published'),
    ('Shenandoah Ridge Trail', 'shenandoah-ridge-trail', 180, 'Trailhead Parking', 'Summit Viewpoint', 'moderate', 'published');
*/
...
-- ✅ 3 main tables (locations, events, routes)
...
-- 4. Set up your .env.local file with Supabase credentials
