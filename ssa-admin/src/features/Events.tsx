        ...
        <div style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 12, marginBottom: 12, background: '#fbfbfb' }}>
          ...
          <div
            ...
            <div style={{ textAlign: 'center' }}>
              {ocrImageUrl ? (
                <img src={ocrImageUrl} alt="pasted" style={{ maxWidth: 120, maxHeight: 120, objectFit: 'contain', borderRadius: 6, border: '1px solid #eee' }} />
              ) : (
                <div style={{ color: '#8b6b34' }}>📋 Paste image</div>
              )}
            </div>
            <div>
              ...
              <small>Tip: click inside this box and press <strong>⌘/Ctrl+V</strong> to paste from clipboard.</small>
            </div>
          </div>
            ...
            <tr key={r.id ?? r.slug ?? r.name}>
              ...
              <td style={{ padding: '8px 6px', borderBottom: '1px solid #f1f1f1' }}>
                <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                  ...
                  <button 
                    className="btn danger" 
                    onClick={()=>softDelete(r.id!.toString())} 
                    style={{ 
                      padding: '6px 10px', 
                      fontSize: '12px',
                      display: 'flex',
