...
|------|------|-------|---------|---------------|
| 2026-06-28 | Dev | Events widget sticky weather | Added a compact weather badge beside the sticky current date, with condition icon and rain percentage when meaningful. Sticky/day weather icons link to the detailed weather.gov forecast page for the active forecast point. Source/public widget copies match and JS syntax checks pass. | Dave — verify sticky weather badge on scroll |
