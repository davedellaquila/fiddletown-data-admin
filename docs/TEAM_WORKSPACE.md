...
|------|------|-------|---------|---------------|
| 2026-06-25 | Dev | Upcountry Jam archive event | Added archived past event `59320bec` for Second Annual Memorial Day Upcountry Jam with poster asset + 8 keywords; image asset pending Pages deploy. | Dave — verify archive row/image if desired |
