        ...
        <div style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 12, marginBottom: 12, background: '#fbfbfb' }}>
          ...
          <div>
            ...
            style={{
                  ...
                  onClick={() => {
                    console.log('OCR paste zone clicked - focusing for paste')
                    setOcrPasteReady(true)
                    ocrPasteRef.current?.focus()
                    // Test if the element is focusable
                    console.log('OCR paste ref current:', ocrPasteRef.current)
                    console.log('OCR paste ref focused:', document.activeElement === ocrPasteRef.current)
                  }}
