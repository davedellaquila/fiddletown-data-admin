...
(function() {
      ...
      element.addEventListener('mouseenter', function(e) {
        ...
        if (isCalendarView) {
          ...
          if (location) {
            ...
            locationLink.className = 'ssa-location';
            locationLink.textContent = location;
            locationLink.setAttribute('data-location', location);
  ...
  function injectStyles() {
    ...
    css.textContent = `
      ...
      .ssa-location{cursor:pointer;text-decoration:underline;text-decoration-style:dotted;text-underline-offset:2px;color:#1e3a8a!important;transition:color 0.2s}
      .ssa-location:hover{color:#1e3a8a!important;text-decoration-style:solid}
      .ssa-card .ssa-location,.ssa-meta .ssa-location{color:#1e3a8a!important}
      .ssa-card .ssa-location:hover,.ssa-meta .ssa-location:hover{color:#1e3a8a!important}
      ...
      .ssa-keyword-tag-clickable{display:inline-block;padding:8px 16px;border:2px solid #d1d5db;border-radius:20px;background:#fff;color:#374151;cursor:pointer;font-size:0.875rem;font-weight:500;line-height:1;transition:all 0.2s}
      ...
      @media(max-width:768px){
        ...
        *{box-sizing:border-box}
        .ssa-controls{padding:10px;gap:12px}
